"""Module that contains the subpixel layer class by
Shi et al. 2016 (see comment in class definition).
"""
...
# Define Subpixel Convolutional layer
class SubpixelConv2D(Layer):
    ...
    # References
        ...
        Efficient Sub-Pixel Convolutional Neural Network Shi et Al.
    ...
    def build(self, input_shape):
        ...
        if last_dim % (factor) != 0:
            raise ValueError('Channel ' + str(last_dim) +
                             ' should be of ' +
