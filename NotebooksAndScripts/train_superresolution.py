"""Script to train an adaptation of the Downsampled-Skip
...
model_folder_name = "SuperResolution"
...
X_train, X_valid, y_train, y_valid = train_test_split(
    X_tot, y_tot, train_size=train_size, random_state=random_state_train
)
...
model_cb = ModelCheckpoint(
    fmodel, monitor="val_loss", save_best_only=True, verbose=1
)
